...
public class RoomOrderDetailServlet extends HttpServlet {
	...
	if ("getOne_For_Display".equals(action)) { // 來自select_page.jsp的請求
		...
		try {
			...
			if (!errorMsgs.isEmpty()) {
				RequestDispatcher failureView = req.getRequestDispatcher("/front-end/roomorderdetail/select_page.jsp");
			...
			if (!errorMsgs.isEmpty()) {
				RequestDispatcher failureView = req
						.getRequestDispatcher("/front-end/roomorderdetail/select_page.jsp");
				failureView.forward(req, res);
				return;//程式中斷
			}
			...
			String url = "/front-end/roomorderdetail/listOneRoomOrderDetail.jsp";
	...
	if ("getOne_For_Update".equals(action)) { // 來自listAllRoomProductCollect.jsp的請求
		...
		try {
			...
			String url = "/front-end/roomorderdetail/update_roomorderdetail_input.jsp";
			...
			RequestDispatcher failureView = req.getRequestDispatcher("/front-end/roomorderdetail/listAllRoomOrderDetail.jsp");
			failureView.forward(req, res);
		}
	}
	...
	if ("update".equals(action)) { // 來自update_roomorderdetail_input.jsp的請求
		...
		try {
			...
			if (!errorMsgs.isEmpty()) {
				...
				RequestDispatcher failureView = req.getRequestDispatcher("/front-end/roomorderdetail/update_roomorderdetail_input.jsp");
				failureView.forward(req, res);
...
//				RequestDispatcher failureView = req
//						.getRequestDispatcher("/front-end/roomorderdetail/addRoomorderdetail.jsp");
//				failureView.forward(req, res);
//				return;
//			}
//			
...
//			String url = "/front-end/roomorderdetail/listAllRoomOrderDetail.jsp";
...
//			RequestDispatcher failureView = req.getRequestDispatcher("/front-end/roomorderdetail/addRoomOrderDetail.jsp");
//			failureView.forward(req, res);
//		}
//	}
//	
	...
	if ("delete".equals(action)) { // 來自listAllRoomOrderDetail.jsp
		...
		try {
			...
			failureView = req.getRequestDispatcher("/front-end/roomorderdetail/listAllRoomOrderDetail.jsp");
			failureView.forward(req, res);
		}
	}
}
