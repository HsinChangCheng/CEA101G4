...
<!-- 			</tr> -->
			  ...
			  <tr>
                    <td>特產商品狀態:</td>
                    <td><input type="radio" id="souSta0" name="sou_status" value="0" <%=(soupVO.getSou_status()==0) ? "checked" :""%> >
                        <label for="roomSta0">下架   </label>
                        <input type="radio" id="souSta1" name="sou_status" value="1" <%=(soupVO.getSou_status()==1) ? "checked" :""%> >
