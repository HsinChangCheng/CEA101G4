...
<title>員工資料新增 - addNews.jsp</title>
...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="<%=request.getContextPath()%>/back-end/news/select_page.jsp"><img src="images/pikachu.jpg" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
