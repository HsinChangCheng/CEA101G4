...
<%
	SouvenirDiscountVO sodVO = (SouvenirDiscountVO) request.getAttribute("sodVO");
%>
...
<title>特產促銷新增 - addSouDis.jsp</title>
			...
			<table>
				...
				<div class="gamescontainer">
					...
					<div class="gamecontainer">
						...
						<p>
							<label for="namelabel">特產促銷商品名稱: </label><input type="text"
								name="sou_dis_name" size="45"
								value="<%=(sodVO == null) ? "苦茶油" : sodVO.getSou_dis_name()%>">
						</p>
						<p>
						...
						<p>
							<label>特產促銷開始日期:</label> <input type="text" id="f_date1"
								name="sou_dis_start" size="45"
								value="<%=(sodVO == null) ? "2020-12-5 6:30:00" : sodVO.getSou_dis_start()%>">
						</p>
						<p>
							<label>特產促銷結束日期:</label> <input type="text" id="f_date2"
								name="sou_dis_end" size="45"
								value="<%=(sodVO == null) ? "2020-12-5 12:30:00 " : sodVO.getSou_dis_end()%>">
						</p>
					

						<p>
							<label>特產促銷折扣:</label><input type="text" name="sou_dis_status"
								size="45"
								value="<%=(sodVO == null) ? "1.0" : sodVO.getSou_dis_status()%>">
						</p>

						
					<p>
							<label for="filelabel">特產照片:</label> <INPUT  type="file" name="photo">
