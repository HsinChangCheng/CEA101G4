...
<%
	SouvenirDiscountVO sodVO = (SouvenirDiscountVO) request.getAttribute("sodVO"); //EmpServlet.java(Concroller), 存入req的empVO物件
%>
...
<title>特產促銷資料 - listOneSouDis.jsp</title>
...
<!-- 		<tr> -->
<!-- 			<td>特產種類</td> -->
<%-- 			<td><%=soutVO.getSou_type_name()%></td> --%>

<!-- 		</tr> -->

		<tr>
			<td>特產促銷開始日期</td>
			<td><%=sodVO.getSou_dis_start()%></td>

		</tr>

		<tr>
			<td>特產促銷結束日期</td>
			<td><%=sodVO.getSou_dis_end()%></td>

		</tr>

		<tr>
			<td>特產促銷折扣</td>
			<td><%=sodVO.getSou_dis_status()%></td>
